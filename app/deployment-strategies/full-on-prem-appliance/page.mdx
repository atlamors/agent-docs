...
flowchart LR
  subgraph customer["Customer-Controlled Infrastructure Boundary"]
    channels["Slack / Telegram / internal systems"] --> runner["Local Hermes runner"]
    runner --> permissions["Local permissions"]
    runner --> connectors["Local connectors"]
    runner --> rag["Local RAG and vector store"]
    runner --> gateway["Local model gateway"]
    gateway --> modelServer["Local model server"]
    runner --> audit["Local logs and audit"]
